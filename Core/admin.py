...
#     list_display = ('plant', 'm_temp', 'm_moist', 'm_ec', 'nitrogen', 'phosphorus', 'potassium', 'm_ph', 'date_time')
#     list_editable = ('m_temp', 'm_moist', 'm_ec', 'nitrogen', 'phosphorus', 'potassium', 'm_ph')
#     list_filter = ('plant', 'm_temp', 'm_moist', 'm_ec', 'nitrogen', 'phosphorus', 'potassium', 'm_ph', 'date_time')
#     search_fields = ('plant__name', 'm_temp', 'm_moist', 'm_ec', 'nitrogen', 'phosphorus', 'potassium', 'm_ph', 'date_time')
#
